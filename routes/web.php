...
Route::get('/gaji',[PinjamansController::class,'gaji'])->name('gaji');
Route::post('/gaji/simpan',[PinjamansController::class,'simpan'])->name('gaji.simpan');

Route::get('/gaji/validate', [PinjamansController::class, 'validateGajiPinjaman'])->name('gaji.validate');

Route::post('/gaji/check-validation', [PinjamansController::class, 'checkValidation'])->name('gaji.checkValidation');
