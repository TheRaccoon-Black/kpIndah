        ...
        {{--  <div class="row">
            <div class="col-md-4">
                <select class="form-select" aria-label="Default select example " id="tipe">
                    ...
                    <option value="tipe">Simpanan Pokok</option>
                    <option value="nominal">Simpanan Wajib</option>
                </select>
            </div>
        </div>  --}}
        <br>
...
{{ $users->links('pagination::bootstrap-5') }} --}}
    ...
    <script>
        ...
        function toggleTable(selectedOption) {
            ...
            } else if (selectedOption === 'tipe') {
                location.href = '/simpanan?type=tipe'
            }
        }
