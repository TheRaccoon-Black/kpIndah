    ...
    <div class="row">
      <div class="col-lg-12 mb-4 order-0">
        <div class="card shadow">
          <div class="d-flex align-items-end row">
            <div class="col-sm-7">
              <div class="card-body">
                <h5 class="card-title text-primary">Selamat Datang di SISKOP DPMPTSP Kota Bengkulu 🎉</h5>
                <p class="mb-4">
      ...
      <div class="row">
        ...
        <div class="col-4 mb-4">
            <div class="card shadow">
                <div class="card-body">
                    <span class="text-primary fw-semibold">Cicilan anggota {{ date('Y') }} (+0.015% bunga)</span>
                ...
                <ul class="p-0 m-0">
                    ...
                    <li class="d-flex mb-4 pb-1">
                      ...
                      <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <div class="user-progress d-flex align-items-center gap-1">
                            <span class="text-muted">Rp</span>
                            <h6 class="mb-0">{{ number_format($item->total,0,',','.') }} <small>(bunga 0.015%)</small></h6>
                        </div>
                      </div>
                    </li>
                    @endforeach
