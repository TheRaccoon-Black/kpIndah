...
<body onload="window.print()">
    <div style="padding-left: 30px; padding-right: 30px">
        <img src="../../assets/img/avatars/logo dpmptsp.png" alt="logo" style="width: 5em; position: absolute;">
        <div style="text-align: center">
            <h4>Laporan Sisa Hasil Usaha <br>
            <span style="font-size: 20px">SISKOP <br>DPMPTSP KOTA BENGKULU</span> <br>
        ...
        <div>
            <table style="font-size: 14px;width: 50%">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>Rp {{ number_format($pinjaman->total,0,',','.') }} (+0.015% bunga)</td>
                </tr>
                <tr>
