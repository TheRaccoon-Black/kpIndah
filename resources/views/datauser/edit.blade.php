                                            ...
                                            <form>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                                               value="{{ old('nama', $user->nama) }}" id="nama" placeholder="Nama" name="nama"
                                                                aria-label="Nama"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" id="nip"
                                                                ...
                                                                value="{{ old('nip', $user->nip) }}" placeholder="NIP" aria-label="NIP."
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" id="email" name="email"
                                                                ...
                                                                @enderror" value="{{ old('email', $user->email) }}" placeholder="email" aria-label="email"
                                                ...
                                                {{-- <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        @enderror" value="{{ old('avatar', $user->avatar) }}" name="avatar" id="customFile" />
                                                    </div>
                                                </div> --}}
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" id="basic-icon-default-phone"
                                                                ...
                                                                value="{{ old('no_hp', $user->no_hp) }}" id="no_hp" name="no_hp"
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                                               value="{{ old('alamat', $user->alamat) }}" id="alamat" placeholder="alamat" name="alamat"
                                                                aria-label="alamat"
                                                                aria-describedby="basic-icon-default-fullname2" />
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="form-check form-check-inline">
                                                                <input type="radio" class="form-check-input"
                                                                    name="jenis_kelamin" id="jk" value="L"  @if (old('jenis_kelamin', $user->jenis_kelamin) === 'jenis_kelamin') checked @endif >
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="jenis_kelamin" id="jk" value="P"  @if (old('jenis_kelamin', $user->jenis_kelamin) === 'jenis_kelamin') checked @endif >
                                                                <label class="form-check-label"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="date" placeholder="Enter Tanggal Masuk"
                                                            ...
                                                            value="{{ old('tanggal_masuk', $user->tanggal_masuk) }}" id="tanggal_masuk"
                                                            name="tanggal_masuk">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                ...
                                                <!-- <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            value="{{ old('password_confirmation', $user->password_confirmation) }}" id="password_confirmation" name="password_confirmation"
